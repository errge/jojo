...
# see http://www.braun-home.net/michael/info/misc/VT100_commands.htm
def cursorhome():
    pr(chr(27) + '[H')

def nextline():
    # A very safe next line: go one line down and 1000 characters to the left
    # But all these movement commands NEVER scroll, so no flickering on the screen
...
# clear screen
pr(chr(27) + '[2J')
# and we turn autowrap off, as we hand position the cursor and
pr(chr(27) + '[?7l')
